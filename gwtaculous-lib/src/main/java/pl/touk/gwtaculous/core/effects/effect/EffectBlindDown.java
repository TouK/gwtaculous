...
/**
 * This effect simulates a window blind down, where the contents of the affected elements stay in place.
 *
 */
public class EffectBlindDown extends Effect {
	
	public EffectBlindDown(Widget widget) {
		super(widget);
	}
